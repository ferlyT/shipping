...
import type { Shipment, ShipmentDimension, ShipmentStatus } from '../types/shipments.types'
...
export default function ShipmentsListPage() {
  ...
  const isInitialLoading = isLoading && !shipmentsData

  if (isInitialLoading) return <LoadingSpinner message="Memuat daftar resi..." />

  return (
    <div className="flex flex-col gap-4 lg:gap-8 bg-[#F8FAFC] p-3 sm:p-4 lg:p-8 min-h-full">
      <PageHeader
        title="Daftar Resi Shipments"
        subtitle="Manage shipment list and tracking information"
        breadcrumbs={[
