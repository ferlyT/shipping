      ...
      >
        ...
        <div className={cn("flex-shrink-0 px-4 sm:px-6 grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 overflow-hidden transition-all duration-200", showStats ? "pt-4 sm:pt-6 pb-2 max-h-96" : "pt-0 pb-0 max-h-0")}>
          <div className="bg-[var(--color-neutral)] rounded-xl p-2.5 sm:p-3 border border-[var(--color-border)] shadow-xs">
            <p className="text-[9px] sm:text-[10px] uppercase font-bold text-[var(--color-secondary)] mb-0.5 sm:mb-1 tracking-wider">Total batch</p>
            <p className="text-xl sm:text-2xl font-bold font-[var(--font-display)] text-[var(--color-primary)]">{stats.totalBatches}</p>
          </div>
          <div className="bg-[var(--color-neutral)] rounded-xl p-2.5 sm:p-3 border border-[var(--color-border)] shadow-xs">
            <p className="text-[9px] sm:text-[10px] uppercase font-bold text-[var(--color-secondary)] mb-0.5 sm:mb-1 tracking-wider">Grup consignee</p>
          ...
          <div className="bg-[var(--color-neutral)] rounded-xl p-2.5 sm:p-3 border border-[var(--color-border)] shadow-xs relative overflow-hidden">
            ...
            <p className="text-[9px] sm:text-[10px] uppercase font-bold text-[var(--color-secondary)] mb-0.5 sm:mb-1 tracking-wider">Kritis (≥30 hari)</p>
            <p className="text-xl sm:text-2xl font-bold font-[var(--font-display)] text-rose-500">{stats.criticalCount}</p>
          </div>
          <div className="bg-[var(--color-neutral)] rounded-xl p-2.5 sm:p-3 border border-[var(--color-border)] shadow-xs">
            <p className="text-[9px] sm:text-[10px] uppercase font-bold text-[var(--color-secondary)] mb-0.5 sm:mb-1 tracking-wider">Tertua</p>
            <p className="text-xl sm:text-2xl font-bold font-[var(--font-display)] text-[var(--color-primary)] flex items-baseline gap-1">
              {stats.maxAging} <span className="text-xs sm:text-sm font-normal text-[var(--color-secondary)]">hari</span>
            </p>
          </div>
        </div>
            ...
            <div className="flex w-full sm:w-auto bg-[var(--color-neutral)] border border-[var(--color-border)] rounded-lg p-0.5">
              <button
                ...
                className={cn(
                  ...
                  sortBy === 'usia' ? "bg-[var(--color-surface)] text-[var(--color-primary)] shadow-xs" : "text-[var(--color-secondary)] hover:text-[var(--color-primary)]"
                )}
              >
                Usia
              </button>
                    ...
                    {displayCodes.map((c, cIdx) => (
                      ...
                      >
                        ...
                        <span className={cn(
                          ...
                          c.aging >= 30 ? "bg-rose-500/20 text-rose-700 dark:text-rose-300" : c.aging >= 8 ? "bg-amber-500/20 text-amber-700 dark:text-amber-300" : "bg-[var(--color-neutral)] text-[var(--color-secondary)]"
                        )}>
                          {c.aging}d
                        </span>
                      </div>
