// ATURAN: Semua type dan interface untuk domain marking didefinisikan di sini
// DILARANG: mendefinisikan ulang interface Marking atau type GroupMode di halaman manapun
